...
const RecuperacionContrasena: React.FC = () => {
  ...
  const handleSendLink = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      setMessage('Si tu correo electrónico está registrado, recibirás un enlace de recuperación.');
      setEmail('');
    }, 2000);
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <div className="w-full max-w-md bg-white shadow-md border border-gray-200 rounded-xl p-6">
        ...
        <input
          ...
          className={`w-full px-4 py-2 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#30588C] ${
