...
export default function VistapreviaReporte() {
  ...
  return (
    <>
      <HeaderAdoptante />
      <div className="max-w-6xl mx-auto mt-6 p-4 bg-white shadow-xl rounded-xl">
        <h2 className="text-2xl font-bold text-center text-[#A672E3] mb-4">Vista Previa de Reporte</h2>
