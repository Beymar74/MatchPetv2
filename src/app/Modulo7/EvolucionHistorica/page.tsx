  ...
  "LaPaz": {
    "Refugio Esperanza": {
      Perro: {
        ...
        valores: [45, 50, 65, 80, 90]
      },
      Gato: {
        anios: [2020, 2021, 2022, 2023, 2024],
        valores: [20, 25, 35, 42, 55]
      }
    },
    "Refugio Huellitas": {
      Perro: {
        anios: [2020, 2021, 2022, 2023, 2024],
        valores: [30, 40, 50, 60, 75]
      },
      Gato: {
        anios: [2020, 2021, 2022, 2023, 2024],
        valores: [15, 18, 22, 30, 40]
      }
    }
  }
};
...
const EvolucionHistorica = () => {
  ...
  const totalPerros = Array.isArray(perros.valores)
    ? perros.valores.reduce((sum, val) => sum + val, 0)
    : 0;

  const totalGatos = Array.isArray(gatos.valores)
    ? gatos.valores.reduce((sum, val) => sum + val, 0)
    : 0;
