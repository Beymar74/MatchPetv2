...
export default function AboutUs() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-r from-[#30588C] via-[#6093BF] to-[#254559] text-white py-8 md:py-12">
      <div className="container mx-auto px-8 md:px-16 flex flex-col md:flex-row gap-8 md:gap-12 items-center">
        
        {/* Logo in a card */}
        <div className="md:w-2/5 flex justify-center">
          <div className="bg-white p-6 rounded-lg shadow-2xl border border-gray-300 max-w-xs mx-auto">
            <Image
              src="/Logo.png"
              alt="MatchPet Logo"
              width={400}
