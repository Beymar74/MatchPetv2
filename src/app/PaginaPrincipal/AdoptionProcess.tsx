...
//cambio para mobile en el archivo AdoptionProcess
export default function AdoptionProcess() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-white py-10 md:py-16">
      <div className="container mx-auto px-8 md:px-16">
        ...
        <div className="flex flex-col md:flex-row justify-between mb-8 md:mb-12">
          ...
          <div className="md:w-1/3 md:pl-8 text-left md:text-right mt-4 md:mt-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          ...
          <div className="bg-gradient-to-r from-[#6093BF] to-[#254559] p-4 md:p-6 rounded-lg shadow-md text-left transition transform hover:scale-105 hover:shadow-xl">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#30588C] mb-4">
              <Search className="w-6 h-6 md:w-8 md:h-8 text-white" strokeWidth={1.5} />
            </div>
            <h3 className="text-base md:text-lg font-semibold mb-2 text-white">Explora y elige</h3>
          ...
          <div className="bg-gradient-to-r from-[#BF3952] to-[#30588C] p-4 md:p-6 rounded-lg shadow-md text-left transition transform hover:scale-105 hover:shadow-xl">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#BF3952] mb-4">
              <FileText className="w-6 h-6 md:w-8 md:h-8 text-white" strokeWidth={1.5} />
            </div>
            <h3 className="text-base md:text-lg font-semibold mb-2 text-white">Envía tu solicitud</h3>
            <p className="text-xs md:text-sm text-white">
          ...
          <div className="bg-gradient-to-r from-[#254559] to-[#6093BF] p-4 md:p-6 rounded-lg shadow-md text-left transition transform hover:scale-105 hover:shadow-xl">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#011526] mb-4">
              <MessageSquare className="w-6 h-6 md:w-8 md:h-8 text-white" strokeWidth={1.5} />
            </div>
            <h3 className="text-base md:text-lg font-semibold mb-2 text-white">Evaluación y contacto</h3>
            <p className="text-xs md:text-sm text-white">
          ...
          <div className="bg-gradient-to-r from-[#6093BF] to-[#BF3952] p-4 md:p-6 rounded-lg shadow-md text-left transition transform hover:scale-105 hover:shadow-xl">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[#30588C] mb-4">
              <CheckCircle className="w-6 h-6 md:w-8 md:h-8 text-white" strokeWidth={1.5} />
            </div>
            <h3 className="text-base md:text-lg font-semibold mb-2 text-white">Adopción y nuevos comienzos</h3>
            <p className="text-xs md:text-sm text-white">
